...
import { MoreDotIcon, ListIcon } from "@/icons";
import { useEffect, useState } from "react";
import { DropdownItem } from "../ui/dropdown/DropdownItem";
import { Parcours } from "../etablissement/Dashboard";
import StudentParcoursModal from "./StudentParcoursModal";
...
export default function TargetChart({
  ...
  const [current, setCurrent] = useState<Parcours[] | null>(null);
